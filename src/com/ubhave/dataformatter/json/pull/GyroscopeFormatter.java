...
public class GyroscopeFormatter extends PullSensorJSONFormatter
{
	...
	{
		GyroscopeData gyroscopeData = (GyroscopeData) data;
		ArrayList<float[]> readings = gyroscopeData.getSensorReadings();
		ArrayList<Long> timestamps = gyroscopeData.getSensorReadingTimestamps();
	...
	public SensorData toSensorData(String jsonString)
	{
		...
		if (jsonData != null)
		{
			...
			try
			{
                GyroscopeProcessor processor = (GyroscopeProcessor) AbstractProcessor.getProcessor(applicationContext, sensorType, setRawData, setProcessedData);
